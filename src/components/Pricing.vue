<template>
  <main class="pricing">
    <div class="d-flex justify-content-between py-5 px-5">
      ...
      <div>
        <h1 class="orange">30,00,000+</h1>
        <h6>Invoices Created</h6>
      </div>
      <div>
        <h1 class="orange">5,000+</h1>
        <h6>Cities &amp; towns in India</h6>
      </div>
      <div>
        <h1 class="orange">4.5 ★</h1>
        <h6>Rating on Google Play</h6>
      </div>
    </div>
    <div class="py-5 px-5">
  ...
  <footer class="pt-4 my-md-5 pt-md-5 mx-5 pricing">
    <div class="d-flex">
      <div class="d-flex w-100 justify-content-between py-5">
        ...
        <div>
          <h1 class="h6 orange">Information</h1>
          <h1 class="h6 fw-normal">Refund Policy</h1>
          <h1 class="h6 fw-normal orange">Privacy Policy</h1>
          <h1 class="h6 fw-normal">Terms &amp; Conditions</h1>
        </div>
        <div>
          <div>&nbsp;</div>
          <h1 class="h6 fw-normal">FAQ's</h1>
          <h1 class="h6 fw-normal">Pricing</h1>
          <h1 class="h6 fw-normal">FloBiz Business Group</h1>
          <h1 class="h6 fw-normal">Blogs</h1>
        </div>
        <div>
